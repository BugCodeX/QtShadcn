...
class GalleryWindow(QtWidgets.QMainWindow):
    ...
    def _build_overview_page(self) -> QtWidgets.QWidget:
        ...
        content = QtWidgets.QLabel(
            ...
            "QLineEdit, QTextEdit, QCheckBox, QRadioButton, QComboBox, QFontComboBox, QLabel."
        )
    ...
    def _build_label_page(self) -> QtWidgets.QWidget:
        ...
        layout.addWidget(self._page_title("QLabel"))
        layout.addWidget(
            self._muted_label(
                "Text labels with shadcn typography styles."
            )
        )
        layout.addWidget(self._separator())
        ...
        layout.addWidget(self._separator())
        layout.addWidget(self._section_label("As field label"))
